...
- Frame Blending 工作流不熟悉的读者看到高 CQP + 高 FPS + 最大性能 NVENC preset 组合会想"为什么不是 cinematic 标准的 CQP 18 / 新式 preset p5 / tune hq"——本 ADR + [[Distribution Ceiling]] 是统一答案。
