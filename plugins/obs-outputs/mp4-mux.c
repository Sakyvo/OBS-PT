...
#ifndef MAX_OUTPUT_AUDIO_ENCODERS
#define MAX_OUTPUT_AUDIO_ENCODERS MAX_AUDIO_MIXES
#endif

#ifndef obs_output_get_video_encoder2
#define obs_output_get_video_encoder2(output, idx) \
	((idx) == 0 ? obs_output_get_video_encoder(output) : NULL)
#endif

#ifndef da_clear
#define da_clear(v) da_resize(v, 0)
#endif
